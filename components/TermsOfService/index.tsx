    ...
    <section className="pb-[120px] pt-[40px]">
      <div className="container">
        ...
        <p className="text-paragraph">
          We are HELLOFY LLC ('Company', 'we', 'us', or 'our'), a company
          registered in UAE at Shams Business Center Building, Sharjah Media
          City Free Zone, Al Messaned, Sharjah,0000, Sharjah, UAE.
        </p>
        <p className="text-paragraph">
          We operate the website{" "}
          <a className="text-primary" href="https://hellofy.ai/">
            https://www.hellofy.ai
          </a>{" "}
        ...
        <p className="text-paragraph">
          You can contact us by phone at +01 99999XXXXX, email at{" "}
          <a className="text-primary" href="mailto:support@hellofy.ai">
            support@hellofy.ai
          </a>
          , or by mail to Shams Business Center Building, Sharjah Media City
          Free Zone, Al Messaned, Sharjah,0000, Sharjah, UAE.
        </p>
        <p className="text-paragraph">
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ('you'), and HELLOFY
        ...
        <p className="text-paragraph">
          ...
          Policy:{" "}
          <a
            href="https://www.hellofy.ai/privacy-policy"
            className="text-primary"
          >
            https://www.hellofy.ai/privacy-policy
          </a>{" "}
          ...
          Services are hosted in UAE. If you access the Services from any other
          ...
          in UAE, then through your continued use of the Services, you are
          transferring your data to UAE, and you expressly consent to have your
          data transferred to and processed in UAE.
        </p>
        <h1 className="text-title-paragraph mb-3 mt-3 flex items-center">
          13{" "}
          <span className="ml-1 mr-3 block h-2 w-2 rotate-45 border-r-2 border-t-2 border-black"></span>{" "}
        ...
        <p className="text-paragraph">
          ...
          of UAE. HELLOFY LLC and yourself irrevocably consent that the courts
          of UAE shall have exclusive jurisdiction to resolve any dispute which
        ...
        <p className="text-paragraph">
          <strong>HELLOFY LLC</strong> <br />
          Shams Business Center Building,
          <br /> Sharjah Media City Free Zone, Al Messaned, Sharjah,0000,
          <br /> Sharjah, UAE.
          <br />
          <strong>Phone:</strong> +01 99999XXXXX <br />
          <a href="mailto:support@hellofy.ai" className="text-primary">
            support@hellofy.ai
          </a>
        </p>

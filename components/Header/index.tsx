...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full items-center transition-all duration-300 border-b-2 border-black_dark ${
          sticky
      ...
      >
        <div className="container">
          ...
          >
            <div className="w-[120px]">
              <Link href="/" className={` flex items-center gap-2`}>
                ...
                <Image
                  ...
                  width={70}
                  height={70}
                  className=" w-[60px] md:w-[60px] dark:hidden"
                />
                <Image
                  src="/images/logo/LogoCustom.svg"
                  alt="logo"
                  width={70}
                  height={70}
                  className="hidden w-[60px] md:w-[60px]  dark:block"
                />
            ...
            <div className="w-full">
              ...
              >
                  ...
                  {menuData.map((menuItem, index) => (
                    <li key={index} className="group relative my-5 md:my-3">
                      {menuItem.path ? (
                        ...
                        //     className={`flex text-base font-medium lg:mr-0 lg:inline-flex lg:px-0  ${
                        ...
                        <>
                          <p
                            ...
                            className="flex cursor-pointer items-center justify-between text-base font-medium text-dark group-hover:text-primary dark:text-white/70 dark:group-hover:text-white lg:mr-0 lg:inline-flex lg:px-0"
                          >
                            {menuItem.title}
                            <span className="pl-3">
                ...
                <div className="flex flex-col gap-3 items-center md:hidden mt-4">
                  <Link
                    href="https://app.hellofy.ai/"
                    className="ease-in-up bg-transparent border-b-4 px-4 py-2.5 text-base font-medium text-dark transition duration-300 hover:bg-opacity-90 md:block rounded-lg border border-black_dark w-full text-center"
                  >
                    Sign In
                  </Link>
                  <Link
                    href="/book-a-demo"
                    className="ease-in-up border-primary border border-b-4 px-4 py-2.5 text-base font-medium text-primary transition duration-300 hover:bg-opacity-90 md:block rounded-lg w-full text-center"
                  >
                    Start free trial
                  </Link>
                </div>
            ...
            <div className="flex w-full justify-center md:justify-end items-center px-4 md:px-8 lg:px-0">
              <div className=" items-center justify-end gap-4 hidden md:flex">
                <Link
                  href="https://app.hellofy.ai/"
                  className="ease-in-up bg-transparent p-2 lg:px-6 lg:py-3 text-sm md:text-base font-medium text-dark transition duration-300 hover:bg-opacity-90  rounded-lg border-2 border-b-4 border-black_dark "
                >
                  Sign In
                </Link>
                <Link
                  href="/book-a-demo"
                  className="ease-in-up rounded-lg bg-transparent border-2 border-b-4 border-primary p-2 lg:px-6 lg:py-3 text-sm md:text-base font-medium text-primary transition duration-300 hover:bg-opacity-90 md:block"
                >
                  Start free trial
                </Link>
              </div>
